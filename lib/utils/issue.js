...
exports.removeLabels = exports.addLabels = exports.getLabels = exports.getState = exports.getRelatedInfo = void 0;
...
const getState = (issue, octokit, context) => __awaiter(void 0, void 0, void 0, function* () {
    return (yield octokit.issues.get({
